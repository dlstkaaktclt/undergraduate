...
#
# Generated by Vivado on Fri Apr 10 20:02:05 +0900 2020
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: fused_mult.sh [-help]
# usage: fused_mult.sh [-lib_map_path]
# usage: fused_mult.sh [-noclean_files]
# usage: fused_mult.sh [-reset_run]
#
...
# executing this script. Please type 'fused_mult.sh -help' for more information.
#
...
# Script info
echo -e "fused_mult.sh - Script generated by export_simulation (Vivado v2018.3 (64-bit)-id)\n"
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../lab5.srcs/sources_1/ip/fused_mult/sim/fused_mult.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fused_mult -o fused_mult_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fused_mult_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fused_mult.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fused_mult_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fused_mult_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fused_mult.sh -help\" for more information)\n"
    exit 1
  fi
