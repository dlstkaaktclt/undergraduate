...
#
# Generated by export_simulation on Fri Apr 10 20:02:05 +0900 2020
#
################################################################################
...
'-reset_run' switch to the './fused_mult.sh' script.

./fused_mult.sh -reset_run
...
./fused_mult.sh -noclean_files

For more information on the script, please type './fused_mult.sh -help'.
